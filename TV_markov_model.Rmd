...
generateSentence <- function(sentence, trigram, duration){
    tokens <- unlist(strsplit(sentence, " ")) # split into words/punctuation
    num <- length(tokens)
...
sentence <- generateSentence("this is", aangTrigram, 15)
...
reformat <- function(sentence){
  ...
  ## find start of line & tokens with sentence ending punctuation
  tokens <- unlist(strsplit(sentence, " "))
...
reformat("omg! idk if this works? oh well")
reformat("yes ppause this might not work pperiod it did eexclamation woo hoo")
